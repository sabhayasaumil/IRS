        ...
        <div class="row-fluid section" id="about">
            <div class="container"> 
                ...
                <div class="explain" style="margin-left:400px">
                    <h2 style="color:black">Business Tax</h2>
						<form action="BusinessTaxProcess.php" method="post" name="signup" id="contact-form" onsubmit="return validateForm()">
                            <fieldset>
                                <div class="row"> 
                                    ...
                                    <div class="field span8">
                                        Total Profit: <input type="text" value="" class="input-text m-wrap m-ctrl-large" id="profit" name="profit" placeholder="Total Profit" Required pattern="[0-9]{4,}"/>
                                    </div>
                                    <div class="field span8">
